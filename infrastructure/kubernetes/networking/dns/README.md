...
| DHCP handout | How do devices learn which resolver to use? | [`../../../network`](../../../network) (MikroTik DHCP) |
...
|---|---|---|---|---|
| [`./coredns`](./coredns) | ⚫ Inactive | Self-hosted | Cluster standard, also good for internal zones | Cluster DNS and authoritative internal DNS |
| [`./adguard-home`](./adguard-home) | ⚫ Inactive | Self-hosted | Chosen LAN resolver for this homelab | Network-wide filtering and forwarding resolver |
| [`./pihole`](./pihole) | ⚫ Inactive | Self-hosted | Documented alternative | Classic network-wide ad-blocking resolver |
...
```text
../../../../helm-charts/networking/dns/<component>/
```
