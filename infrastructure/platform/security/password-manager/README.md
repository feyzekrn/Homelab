...
|---|---|---|---|---|---|---|
| Bitwarden (Vaultwarden) | [docs](./bitwarden) · [config](./bitwarden/terraform) | ⚫ Inactive | lxc | ~50–100 MB | Chosen password manager (via Vaultwarden server) | Family password vault with clients on every platform |
