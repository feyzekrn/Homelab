...
- Where does DNS live and how are internal names resolved? (planned answer: [`dns`](../../infrastructure/platform/dns) — AdGuard Home as LAN resolver, CoreDNS for internal zones, handed out via MikroTik DHCP)
