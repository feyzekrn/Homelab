...
Planned configuration location, following the repository convention that Terraform lives next to the component it configures:

```text
./terraform/    # RouterOS provider: VLANs, DHCP, firewall, port config
```

Once created, this README should link to the exact module and state backend notes.
