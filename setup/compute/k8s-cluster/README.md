# ☸️ k8s-cluster — Nodes, CPU, RAM & Storage
...
The foundation of the bare-metal Kubernetes cluster. Three identical mini PCs, bought as **barebones on eBay** — meaning they came with a weak Pentium CPU and no RAM. That is completely fine because both get replaced anyway.
